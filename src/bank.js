class BankAccount {
  ...
  static #totalNumberOfAccounts = 0; // private static property
  ...
  deposit(amount) {
    ...
    // added private property #balance
    // return this.balance;
    return this.#balance;
  }
  ...
  withdraw(amount) {
    if (amount > this.#balance) {
      ...
      this.#balance -= amount; // added private property #balance
      console.log(`Withdrew $${amount}. New balance: $${this.#balance}`); // added private property #balance
    }
    return this.#balance; // added private property #balance
  }

  getBalance() {
    // return #balance;
    return this.#balance; // added this
  }
...
class Bank {
  ...
  addAccount(account) {
    this.accounts.push(account); // added this
  }

  getTotalBalance() {
    let total = 0;
    this.accounts.forEach((account) => {
      total += account.getBalance(); // since balance is private, we have to call the method
    });
    return total;
  }
